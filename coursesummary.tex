...
\]
Because the vertices of $\sigma$ are affinely independent, the columns of $\tilde{B}$ are linearly independent.
Thus $\tilde{B}$ is invertible on its span, and we have
\[
...
$$
j: (X,A)(X\setminus U, A\setminus U)
$$
...
\begin{exercise}
	...
	\[
	\{(0, y) \in \mathbb{R}^2 \mid -1 \le y \le 1\} 
	\;\cup\;
	\{(x, \sin(1/x)) \in \mathbb{R}^2 \mid 0 < x \le 1\}.
	\]
\end{exercise}
